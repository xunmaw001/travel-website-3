...
public class DiscusstesemeishiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscusstesemeishiEntity discusstesemeishi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusstesemeishiEntity discusstesemeishi, HttpServletRequest request){
        EntityWrapper<DiscusstesemeishiEntity> ew = new EntityWrapper<DiscusstesemeishiEntity>();
		PageUtils page = discusstesemeishiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusstesemeishi), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscusstesemeishiEntity> wrapper = new EntityWrapper<DiscusstesemeishiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discusstesemeishiService.selectCount(wrapper);
