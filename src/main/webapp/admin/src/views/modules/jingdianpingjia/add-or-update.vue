      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="总价格" prop="zongjiage">
          <el-input v-model="ruleForm.zongjiage" 
              placeholder="总价格" clearable  :readonly="ro.zongjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="景点评分" prop="jingdianpingfen">
          <el-select v-model="ruleForm.jingdianpingfen" placeholder="请选择景点评分">
            <el-option
                v-for="(item,index) in jingdianpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="景点评分" prop="jingdianpingfen">
	      <el-input v-model="ruleForm.jingdianpingfen"
                placeholder="景点评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="景点评价" prop="jingdianpingjia">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingdianpingjia" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingdianpingjia" label="景点评价" prop="jingdianpingjia">
                    <span v-html="ruleForm.jingdianpingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	menpiaojiage : false,
	zongjiage : false,
	jingdianpingfen : false,
	jingdianpingjia : false,
	yonghuming : false,
	shouji : false,
	sfsh : false,
	shhf : false,
            ...
            ruleForm: {
                  ...
                  jingdianpingjia: [
                            { required: true, message: '景点评价不能为空', trigger: 'blur' },
                                    	                                                              ],
                  yonghuming: [
                                    	                                                              ],
                  shouji: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjiage = true;
            continue;
	            	            ...
	            	            if(o=='jingdianpingfen'){
            this.ruleForm.jingdianpingfen = obj[o];
	    this.ro.jingdianpingfen = true;
            continue;
          }
	            	            if(o=='jingdianpingjia'){
            this.ruleForm.jingdianpingjia = obj[o];
	    this.ro.jingdianpingjia = true;
            continue;
          }
	            	            if(o=='yonghuming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.jingdianpingfenOptions = "1,2,3,4,5".split(',')
                                                                                                                      },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
        url: `jingdianpingjia/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingdianpingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingdianpingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
