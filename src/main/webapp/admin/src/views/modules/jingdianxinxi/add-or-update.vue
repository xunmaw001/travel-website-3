    ...
    >
      <el-row>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="景点星级" prop="jingdianxingji">
          <el-select v-model="ruleForm.jingdianxingji" placeholder="请选择景点星级">
            <el-option
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdiantupian = true;
            continue;
	            	            ...
	            	            if(o=='jingdianxingji'){
            this.ruleForm.jingdianxingji = obj[o];
	    this.ro.jingdianxingji = true;
            continue;
          }
	            	            if(o=='jingdiandizhi'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                          ...
                                                          this.jingdianxingjiOptions = "A,AA,AAA,AAAA,AAAAA".split(',')
                                                                                                                                                          },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
