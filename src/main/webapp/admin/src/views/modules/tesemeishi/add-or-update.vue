          ...
          <el-form-item class="input" label="打卡地点" prop="dakadidian">
              <el-input v-model="ruleForm.dakadidian" 
                placeholder="打卡地点" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人均消费" prop="renjunxiaofei">
          <el-input v-model="ruleForm.renjunxiaofei" 
              placeholder="人均消费" clearable  :readonly="ro.renjunxiaofei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人均消费" prop="renjunxiaofei">
              <el-input v-model="ruleForm.renjunxiaofei" 
                placeholder="人均消费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="美食介绍" prop="meishijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.meishijieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.meishijieshao" label="美食介绍" prop="meishijieshao">
                    <span v-html="ruleForm.meishijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renjunxiaofei = true;
            continue;
	            	            ...
	            	            if(o=='meishijieshao'){
            this.ruleForm.meishijieshao = obj[o];
	    this.ro.meishijieshao = true;
            continue;
          }
	                    }
                                                                                                              }
